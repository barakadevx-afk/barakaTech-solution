...
import { ExternalLink, Github, Eye, Sparkles, X, Globe, Calendar, Tag, ArrowRight, Filter, Heart, FolderOpen } from 'lucide-react'
import { fetchProjects } from '../lib/api'

const filters = ['All', 'Featured', 'Web', 'Mobile', 'Game Dev']
      ...
      <div className="max-w-7xl mx-auto container-padding">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-24">
            <p className="text-gray-500 dark:text-gray-400 text-lg animate-pulse">Loading projects...</p>
          </div>
        ) : projects.length === 0 ? (
          <div className="flex items-center justify-center py-24">
